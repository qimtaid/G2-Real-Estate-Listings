...
<div className="card-container">
  <div className="card" id="whoWeAre">
    <h3>Who We Are</h3><br/>
    <p>Real Estate Listing Portal is your one-stop destination for finding, buying, renting, and listing properties. Whether you are looking for a cozy apartment to rent or a luxurious villa to buy, or you need a platform to list your vacation home for short stays, we cater to all your real estate needs.</p>
  </div>
